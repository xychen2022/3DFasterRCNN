...
class NonMaxSuppressionV5Base : public OpKernel {
 public:
  explicit NonMaxSuppressionV5Base(OpKernelConstruction* context)
      : OpKernel(context) {}
...
class NonMaxSuppressionV5Op : public NonMaxSuppressionV5Base {
 public:
  explicit NonMaxSuppressionV5Op(OpKernelConstruction* context)
      : NonMaxSuppressionV5Base(context) {
...
#define REGISTER_KERNEL(T)  \
  REGISTER_KERNEL_BUILDER(Name("NonMaxSuppressionV5").Device(DEVICE_CPU), \
                          NonMaxSuppressionV5Op<CPUDevice>);
...
#define REGISTER_KERNEL()                                         \
  REGISTER_KERNEL_BUILDER(Name("NonMaxSuppressionV5")           \
                              .Device(DEVICE_GPU)                  \
                          NonMaxSuppressionV5Op<GPUDevice>);
